...
//将字符串转成小写
+ (NSString *)stringToLowerCase:(NSString *)string {
    //转成了可变字符串
    ...
    //去掉空格
    strPinYin = [strPinYin stringByReplacingOccurrencesOfString:@" " withString:@""];
...
/**
 ...
 @return 剪裁好的图片
 */
+ (UIImage *)cutPicWithPicUrl:(NSString *)url bigOrSmall:(CGFloat)num picLocationType:(int)type {
    //显示图片的上半部分
